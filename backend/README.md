...
## Project Structure
    ...
    ├── testapiautostoryboa_78759  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_78759`
...
2. Clone this repo and `cd testapiautostoryboa_78759`
